    ...
    Archive Tool Edm9bm
    ===================
    Zero-dependency command-line tool designed to validate local resources efficiently.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Zero-dependency command-line tool designed to validate local resources efficiently.")
